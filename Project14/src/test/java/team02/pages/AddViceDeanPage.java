...
public class AddViceDeanPage {
    public AddViceDeanPage() {
    ...
    @FindBy(id = "password") public WebElement adminPassword;
    @FindBy(xpath ="//div[@class='Toastify__toast-body']/div[.='Vice dean Saved']") public WebElement VicedeanSavedPopUp;
    @FindBy (css = ".btn-primary") public WebElement adminSubmit;
