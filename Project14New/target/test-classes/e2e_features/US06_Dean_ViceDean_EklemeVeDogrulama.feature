@E2E
Feature: Dean Vice deani Ekleme, Dogrulama ve Silme Yapabilmeli

  @UI
  Scenario: Dean Web Sitesinde Vice Dean Ekleyebilmeli (UI)
    Given Kullanici Web sitesine gider
    When Kullanici Logine tiklar
    And  Username Kutucuguna "celaltas1" girer
  ...
  @API
  Scenario: Olusturulan Dean hesap bilgisini alma testi (API)
    Given "Dean" deanyetkisi ile giris yapilir
