...
public class AddViceDeanStepDefs {
    ...
    @When("Username Kutucuguna {string} girer")
    public void dean_usernamei_girer(String string) {
        addVicedean.usernameBox.sendKeys(string);
    }
    ...
    public void vice_dean_kaydi_yapilamadigi_dogrulanir() {
        Assert.assertFalse(addVicedean.deanBirthPlaceBoxRequired.isDisplayed());
    }
